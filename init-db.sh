...
CREATE TABLE IF NOT EXISTS aliases (source varchar(512) NOT NULL, destination varchar(512) NOT NULL, PRIMARY KEY (source));
...
INSERT IGNORE INTO aliases (source,destination) VALUES ('$EMAIL_EAI_USER@$DOMAIN_PUNNY', '$EMAIL_USER@$DOMAINNAME');
